    ...
    <div>
        ...
        <div class="container" >
            <div style="display: flex;justify-content: space-between;">
                <div style="width: 50%;">
                    <el-input v-model="search_input" style="max-width: 1000px;padding: 20px;" placeholder="搜索">
                        <template #append>
            ...
            <div class="custom-style" style="padding-top: 0px !important;">
                <el-segmented v-model="seg_value" :options="typeList" @change="handleCommand" block>
                    <template #default="scope">
                        <div style="text-align: center;padding: 0px 10px;font-size: 15px;">{{ scope.item }}</div>
                    </template>
                </el-segmented>
            </div>
            <div class="materials">
