<template>
    <div style="height: 100%;">
        ...
        <!-- 主要内容结束 -->
         <!-- 抽屉开始 -->
        <el-drawer v-model="drawerVisable" title="选择素材"  size="65%" class="mydrawer" @open="handleDrawerOpen">
         ...
         <!-- 抽屉结束 -->
          <!-- 抽屉2开始 -->
        <el-drawer v-model="drawerVisable2" title="收藏列表"  size="65%" class="mydrawer" @open="handleDrawerOpen">
      ...
      project:[
        {
          ...
          "time": [
            ...
            "00:00:01,851 --> 00:00:03,967",
            "00:00:04,010 --> 00:00:06,097"
          ],
          "text": [
            "你明明是高考满分的三好学生",
            "却被父亲气急败坏的揍了三天三夜",
          ...
          "image": [
            "D:\\YJtest\\JianyingPro Drafts\\draft\\jbh\\你明明是高考满分的三好学生\\1-5b979efd-2cf4-4919-9ed3-44469ae43a74.png",
            "D:\\YJtest\\JianyingPro Drafts\\draft\\jbh\\你明明是高考满分的三好学生\\1-5b979efd-2cf4-4919-9ed3-44469ae43a74.png",
          ]
        },
        {
...
::v-deep .el-table .el-table__row .custom-index-column .cell {
  cursor: text;
  user-select: text;
}
::v-deep  .el-tag {
