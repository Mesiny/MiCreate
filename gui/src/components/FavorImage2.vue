<template>
  <div>
    ...
    <div class="materials" style="height: calc(100vh - 300px);overflow-y:auto;">
        ...
        <el-card class="card black-border" v-for="(item, index) in cardList.slice((currentPage - 1) * pageSize, currentPage * pageSize)" :key="item.id" @click="item.choosed = !item.choosed">
            <div class="info">
            ...
            <div class="image-overlay">
              ...
              <div style="display: flex;gap:10px;position: relative;bottom: 0px;">
                <el-icon color="white" size="large" @click="handlePreview($event,index)"><Search /></el-icon>
...
.green-border {
  border: 2
  px solid rgba(14, 209, 104, 0.637);
}
.upload-demo {
  margin-bottom: 20px;
}
