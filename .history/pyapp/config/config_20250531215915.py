...
class Config:
    ...
    ##
    appName = '圆梦'  # 应用名称
    appNameEN = 'CircleDream'    # 应用名称-英文（用于生成缓存文件夹，必须是英文）
    appTitle = '圆梦'
    appVersion = "V1.2.0"  # 应用版本号  V1.1.1  一定注意：这里的V必须大写
    appDeveloper = "YuXin"  # 应用开发者
    appBlogs = ""  # 个人博客
    appPackage = 'vip.YuXin'    # 应用包名，用于在本地电脑生成 vip.pangao.ppx 唯一文件夹
    appUpdateUrl = 'https://api.github.com/repos/Mesiny/MiCreate/releases/latest'    # 获取程序更新信息 https://api.github.com/repos/pangao1990/ppx/releases/latest
